...
class GLReconItem(BaseModel):
    ...
    rate: Optional[float] = Field(None, alias="rate", description="Tax rate in decimal format (e.g., 0.0265)")
    wht_normal: Optional[float] = Field(None, alias="whtNormal", description="Normal withholding tax amount")
    remarks: Optional[str] = Field(None, alias="remarks", description="Remarks or notes")
...
class GLTransaction(BaseModel):
    ...
    tax_based_wht_normal: Optional[float] = Field(None, alias="taxBasedWhtNormal", description="Tax base amount for withholding tax normal")
